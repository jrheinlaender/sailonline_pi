...
SailonlineUiBase::SailonlineUiBase(wxWindow* parent, wxWindowID id,
  ...
  m_mFile->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineUiBase::OnOpen), this,
                m_mOpen->GetId());
  m_mFile->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineUiBase::OnSave), this,
                m_mSave->GetId());
  m_mFile->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineUiBase::OnClose), this,
                m_mClose->GetId());
  m_mPosition->Bind(wxEVT_COMMAND_MENU_SELECTED,
                    wxCommandEventHandler(SailonlineUiBase::OnNewPosition),
                    this, m_mNewPosition->GetId());
  m_mPosition->Bind(wxEVT_COMMAND_MENU_SELECTED,
                    wxCommandEventHandler(SailonlineUiBase::OnUpdateBoat), this,
                    m_mUpdateBoat->GetId());
  m_mPosition->Bind(wxEVT_COMMAND_MENU_SELECTED,
                    wxCommandEventHandler(SailonlineUiBase::OnDeletePosition),
                    this, m_mDeletePosition->GetId());
  m_mPosition->Bind(
      wxEVT_COMMAND_MENU_SELECTED,
      wxCommandEventHandler(SailonlineUiBase::OnDeleteAllPositions), this,
  ...
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         ...
                         m_mNew->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineUiBase::OnBatch), this,
                         m_mBatch->GetId());
  m_mConfiguration->Bind(
      ...
      m_mEdit->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineUiBase::OnGoTo), this,
                         m_mGoTo->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineUiBase::OnDelete),
                         this, m_mDelete->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineUiBase::OnDeleteAll),
                         this, m_mDeleteAll->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineUiBase::OnCompute),
                         this, m_mCompute->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineUiBase::OnComputeAll),
                         this, m_mComputeAll->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineUiBase::OnStop), this,
                         m_mStop->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineUiBase::OnResetAll),
                         this, m_mResetAll->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineUiBase::OnExport),
                         this, m_mExport->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineUiBase::OnExportAll),
                         this, m_mExportAll->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineUiBase::OnFilter),
                         this, m_mFilter->GetId());
  m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineUiBase::OnSettings), this,
                m_mSettings->GetId());
  m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineUiBase::OnStatistics), this,
                m_mStatistics->GetId());
  m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineUiBase::OnReport), this,
                m_mReport->GetId());
  m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineUiBase::OnPlot), this,
                m_mPlot->GetId());
  m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineUiBase::OnCursorPosition), this,
                m_mCursorPosition->GetId());
  m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineUiBase::OnRoutePosition), this,
                m_mRoutePosition->GetId());
  m_mHelp->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineUiBase::OnInformation), this,
                m_mInformation->GetId());
  m_mHelp->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineUiBase::OnManual), this,
                m_mManual->GetId());
  m_mHelp->Bind(wxEVT_COMMAND_MENU_SELECTED,
  ...
  m_mContextMenu->Bind(
      ...
      m_mEdit1->GetId());
  m_mContextMenu->Bind(wxEVT_COMMAND_MENU_SELECTED,
                       wxCommandEventHandler(SailonlineUiBase::OnCompute), this,
                       m_mCompute1->GetId());
  m_mContextMenu->Bind(wxEVT_COMMAND_MENU_SELECTED,
                       wxCommandEventHandler(SailonlineUiBase::OnComputeAll),
...
SailonlinePanel::SailonlinePanel(wxWindow* parent, wxWindowID id,
  ...
  fgSizer1061->Add(m_staticText168, 0, wxALL, 5);

  m_polarname = new wxStaticText(m_raceinfo, wxID_ANY, _("not loaded"),
                                 wxDefaultPosition, wxDefaultSize, 0);
  m_polarname->Wrap(-1);
  fgSizer1061->Add(m_polarname, 0, wxALL, 5);

  m_pbutton_downloadpolar = new wxButton(m_raceinfo, wxID_ANY, _("Download"),
                                         wxDefaultPosition, wxDefaultSize, 0);
  fgSizer1061->Add(m_pbutton_downloadpolar, 0, wxALL, 5);

  bSizer11->Add(fgSizer1061, 1, wxEXPAND, 5);
  ...
  m_pdclist = new wxListCtrl(
      m_dcs, wxID_ANY, wxDefaultPosition, wxSize(-1, -1),
