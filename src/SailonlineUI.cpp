...
SailonlineBase::SailonlineBase(wxWindow* parent, wxWindowID id,
  ...
  m_mExport = new wxMenuItem(m_mConfiguration, wxID_ANY,
                             wxString(_("E&xport")) + wxT('\t') + wxT("Ctrl+X"),
                             wxEmptyString, wxITEM_NORMAL);
  ...
  this->Connect(
      wxEVT_RIGHT_DOWN,
      wxMouseEventHandler(SailonlineBase::SailonlineBaseOnContextMenu), NULL,
      this);
  ...
  this->Connect(wxEVT_CLOSE_WINDOW,
                wxCloseEventHandler(SailonlineBase::OnClose));
  this->Connect(wxEVT_SIZE, wxSizeEventHandler(SailonlineBase::OnSize));
  m_mFile->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnOpen), this,
                m_mOpen->GetId());
  m_mFile->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnSave), this,
                m_mSave->GetId());
  m_mFile->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnClose), this,
                m_mClose->GetId());
  m_mPosition->Bind(wxEVT_COMMAND_MENU_SELECTED,
                    wxCommandEventHandler(SailonlineBase::OnNewPosition), this,
                    m_mNewPosition->GetId());
  m_mPosition->Bind(wxEVT_COMMAND_MENU_SELECTED,
                    wxCommandEventHandler(SailonlineBase::OnUpdateBoat), this,
                    m_mUpdateBoat->GetId());
  m_mPosition->Bind(wxEVT_COMMAND_MENU_SELECTED,
                    wxCommandEventHandler(SailonlineBase::OnDeletePosition),
                    this, m_mDeletePosition->GetId());
  m_mPosition->Bind(wxEVT_COMMAND_MENU_SELECTED,
                    wxCommandEventHandler(SailonlineBase::OnDeleteAllPositions),
                    this, m_mDeleteAllPositions->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineBase::OnNew), this,
                         m_mNew->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineBase::OnBatch), this,
                         m_mBatch->GetId());
  m_mConfiguration->Bind(
      wxEVT_COMMAND_MENU_SELECTED,
      wxCommandEventHandler(SailonlineBase::OnEditConfiguration), this,
      m_mEdit->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineBase::OnGoTo), this,
                         m_mGoTo->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineBase::OnDelete), this,
                         m_mDelete->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineBase::OnDeleteAll),
                         this, m_mDeleteAll->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineBase::OnCompute), this,
                         m_mCompute->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineBase::OnComputeAll),
                         this, m_mComputeAll->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineBase::OnStop), this,
                         m_mStop->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineBase::OnResetAll),
                         this, m_mResetAll->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineBase::OnExport), this,
                         m_mExport->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineBase::OnExportAll),
                         this, m_mExportAll->GetId());
  m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED,
                         wxCommandEventHandler(SailonlineBase::OnFilter), this,
                         m_mFilter->GetId());
  m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnSettings), this,
                m_mSettings->GetId());
  m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnStatistics), this,
                m_mStatistics->GetId());
  m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnReport), this,
                m_mReport->GetId());
  m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnPlot), this,
                m_mPlot->GetId());
  m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnCursorPosition), this,
                m_mCursorPosition->GetId());
  m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnRoutePosition), this,
                m_mRoutePosition->GetId());
  m_mHelp->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnInformation), this,
                m_mInformation->GetId());
  m_mHelp->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnManual), this,
                m_mManual->GetId());
  m_mHelp->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnAbout), this,
                m_mAbout->GetId());
  ...
  m_mContextMenu->Bind(wxEVT_COMMAND_MENU_SELECTED,
                       ...
                       m_mBatch1->GetId());
  m_mContextMenu->Bind(wxEVT_COMMAND_MENU_SELECTED,
                       wxCommandEventHandler(SailonlineBase::OnResetAll), this,
                       m_mResetAll1->GetId());
  ...
  m_menu1->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnCursorPosition), this,
                m_mCursorPosition1->GetId());
  m_menu1->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(SailonlineBase::OnRoutePosition), this,
                m_mRoutePosition1->GetId());
}
...
WeatherRoutingPanel::WeatherRoutingPanel(wxWindow* parent, wxWindowID id,
  ...
  m_bExport = new wxButton(sbSizer29->GetStaticBox(), wxID_ANY, _("&Export"),
                           wxDefaultPosition, wxDefaultSize, 0);
...
ConfigurationDialogBase::ConfigurationDialogBase(wxWindow* parent,
  ...
  fgSizer111->Add(
      m_tpTime, 1,
      wxALIGN_CENTER_VERTICAL | wxALIGN_CENTER_HORIZONTAL | wxEXPAND | wxALL,
      5);
  ...
  m_sSafetyMarginLand = new wxSpinCtrl(
      sbOptions1->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
      wxSize(140, -1), wxSP_ARROW_KEYS, 0, 100, 0);
  ...
  m_sByDegrees = new wxTextCtrl(sbCourses->GetStaticBox(), wxID_ANY, _("5"),
...
PlotDialogBase::PlotDialogBase(wxWindow* parent, wxWindowID id,
  ...
  fgSizer12->Add(m_staticText138, 1,
                 wxALL | wxALIGN_RIGHT | wxEXPAND | wxALIGN_CENTER_VERTICAL, 5);
  ...
  m_staticText139 = new wxStaticText(this, wxID_ANY, _("Scale"),
                                     wxDefaultPosition, wxDefaultSize, 0);
  m_staticText139->Wrap(-1);
  fgSizer12->Add(m_staticText139, 1,
                 wxALL | wxALIGN_RIGHT | wxEXPAND | wxALIGN_CENTER_VERTICAL, 5);
  ...
  fgSizer16->Add(
      m_sdbSizer4, 1,
      wxEXPAND | wxALL | wxALIGN_CENTER_VERTICAL | wxALIGN_CENTER_HORIZONTAL,
      5);
