...
SailonlineBase::SailonlineBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	this->Connect( wxEVT_RIGHT_DOWN, wxMouseEventHandler( SailonlineBase::SailonlineBaseOnContextMenu ), NULL, this );


	this->Centre( wxBOTH );

	// Connect Events
	this->Connect( wxEVT_CLOSE_WINDOW, wxCloseEventHandler( SailonlineBase::OnClose ) );
	this->Connect( wxEVT_SIZE, wxSizeEventHandler( SailonlineBase::OnSize ) );
	m_mFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnOpen ), this, m_mOpen->GetId());
	m_mFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnSave ), this, m_mSave->GetId());
	m_mFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnClose ), this, m_mClose->GetId());
	m_mPosition->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnNewPosition ), this, m_mNewPosition->GetId());
	m_mPosition->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnUpdateBoat ), this, m_mUpdateBoat->GetId());
	m_mPosition->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnDeletePosition ), this, m_mDeletePosition->GetId());
	m_mPosition->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnDeleteAllPositions ), this, m_mDeleteAllPositions->GetId());
	m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnNew ), this, m_mNew->GetId());
	m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnBatch ), this, m_mBatch->GetId());
	m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnEditConfiguration ), this, m_mEdit->GetId());
	m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnGoTo ), this, m_mGoTo->GetId());
	m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnDelete ), this, m_mDelete->GetId());
	m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnDeleteAll ), this, m_mDeleteAll->GetId());
	m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnCompute ), this, m_mCompute->GetId());
	m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnComputeAll ), this, m_mComputeAll->GetId());
	m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnStop ), this, m_mStop->GetId());
	m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnResetAll ), this, m_mResetAll->GetId());
	m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnExport ), this, m_mExport->GetId());
	m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnExportAll ), this, m_mExportAll->GetId());
	m_mConfiguration->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnFilter ), this, m_mFilter->GetId());
	m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnSettings ), this, m_mSettings->GetId());
	m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnStatistics ), this, m_mStatistics->GetId());
	m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnReport ), this, m_mReport->GetId());
	m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnPlot ), this, m_mPlot->GetId());
	m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnCursorPosition ), this, m_mCursorPosition->GetId());
	m_mView->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnRoutePosition ), this, m_mRoutePosition->GetId());
	m_mHelp->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnInformation ), this, m_mInformation->GetId());
	m_mHelp->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnManual ), this, m_mManual->GetId());
	m_mHelp->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnAbout ), this, m_mAbout->GetId());
	m_mContextMenu->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnNew ), this, m_mNew1->GetId());
	m_mContextMenu->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnEditConfiguration ), this, m_mEdit1->GetId());
	m_mContextMenu->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnCompute ), this, m_mCompute1->GetId());
	m_mContextMenu->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnComputeAll ), this, m_mComputeAll1->GetId());
	m_mContextMenu->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnDelete ), this, m_mDelete1->GetId());
	m_mContextMenu->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnGoTo ), this, m_mGoTo1->GetId());
	m_mContextMenu->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnStop ), this, m_mStop1->GetId());
	m_mContextMenu->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnBatch ), this, m_mBatch1->GetId());
	m_mContextMenu->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnResetAll ), this, m_mResetAll1->GetId());
	m_menu1->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnSettings ), this, m_mSettings1->GetId());
	m_menu1->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnStatistics ), this, m_mStatistics1->GetId());
	m_menu1->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnReport ), this, m_mReport1->GetId());
	m_menu1->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnPlot ), this, m_mPlot1->GetId());
	m_menu1->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnCursorPosition ), this, m_mCursorPosition1->GetId());
	m_menu1->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( SailonlineBase::OnRoutePosition ), this, m_mRoutePosition1->GetId());
}

SailonlineBase::~SailonlineBase()
{
	// Disconnect Events
	this->Disconnect( wxEVT_CLOSE_WINDOW, wxCloseEventHandler( SailonlineBase::OnClose ) );
	this->Disconnect( wxEVT_SIZE, wxSizeEventHandler( SailonlineBase::OnSize ) );
...
SailonlinePanel::SailonlinePanel( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	fgSizer106->Add( m_racedesc, 100, wxEXPAND, 5 );


	bSizer12->Add( fgSizer106, 1, wxEXPAND, 5 );


	m_psizer_racedata->Add( bSizer12, 1, wxEXPAND, 5 );


	bSizer8->Add( m_psizer_racedata, 1, wxEXPAND, 5 );
	...
	m_pdclist = new wxListCtrl( m_dcs, wxID_ANY, wxDefaultPosition, wxSize( -1,-1 ), wxLC_HRULES|wxLC_NO_SORT_HEADER|wxLC_REPORT|wxHSCROLL|wxVSCROLL );
	...
	fgSizer17->Add( fgSizer18, 1, wxEXPAND, 5 );
