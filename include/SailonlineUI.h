...
///////////////////////////////////////////////////////////////////////////////
/// Class SailonlineBase
///////////////////////////////////////////////////////////////////////////////
class SailonlineBase : public wxFrame
{
	private:
	...
	public:
		...
		SailonlineBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Sailonline"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxCAPTION|wxCLOSE_BOX|wxFRAME_FLOAT_ON_PARENT|wxFRAME_NO_TASKBAR|wxRESIZE_BORDER|wxSYSTEM_MENU|wxTAB_TRAVERSAL );

		~SailonlineBase();

		void SailonlineBaseOnContextMenu( wxMouseEvent &event )
		{
